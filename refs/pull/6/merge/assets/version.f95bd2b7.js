import{a as i,y as t,F as e,b as r,aI as a,Q as o,s as l,aJ as n}from"./vendor.f825c847.js";import{i as s,T as c,u as d,I as h}from"./main.18186bd7.js";import{T as g}from"./Radio.2c134f7f.js";let v=!1;function p({style:l}){const[n,p]=i(v);if(t((()=>s("PWA","update",(()=>p(!0))))),!n)return null;const w=e(g);return"titlebar"===l?r("div",{class:"actions"},r(c,{content:"A new update is available!",placement:"bottom"},r("div",{onClick:()=>d(!0)},r(a,{size:22,color:w.success})))):window.isNative?null:r(h,{onClick:()=>d(!0)},r(o,{size:22,color:w.success}))}s("PWA","update",(()=>v=!0));const w=l.div`
